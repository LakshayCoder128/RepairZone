...
<div class="container">        
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="background">
                ...
                <form name="sturegForm" id="sturegForm" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?php //echo $input_error1;?>" id="staticName" name="sname" value="<?php echo $data['dbname'];?>">
                            <span class="error"><?php //echo $nameErr;?></span>
                        </div>
                    </div>         
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?php //echo $input_error2;?>" id="staticRollno" value="<?php echo $data['dbroll'];?>" name="sroll">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?php //echo $input_error3;?>" id="staticAge" value="<?php echo $data['dbage'];?>" name="sage" minlength="2" maxlength="3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <input type="text" class="form-control calendar <?php //echo $input_error4;?>" id="staticDOB" name="sdob" placeholder="DD-MM-YYYY" value="<?php echo $data['dbdob'];?>" />
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Contact No.</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?php //echo $input_error5;?>" id="staticPhone" value="<?php echo $data['dbphone'];?>" name="sphone">
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Address</label>
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <textarea class="form-control <?php //echo $input_error6;?>" id="staticAddress" rows="2" name="saddress"><?php echo $data['dbaddress'];?></textarea>
                        ...
                        <label for="staticEmail" class="col-sm-2 col-form-label">Gender</label>
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input sgender" type="radio" name="sgender" id="inlineRadio1" value="Male" <?php echo ($data['dbgender']=='Male')? 'checked="checked"':'';?> />
                                    <label class="col-form-label form-check-label" for="inlineRadio1">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input sgender" type="radio" name="sgender" id="inlineRadio2" value="Female" <?php echo ($data['dbgender']=='Female')? 'checked="checked"':'';?> />
                                    <label class="form-check-label" for="inlineRadio2">Female</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input sgender" type="radio" name="sgender" id="inlineRadio3" value="Other" <?php echo ($data['dbgender']=='Other')? 'checked="checked"':'';?> />
                    ...
                    <?php
                    $dpref = json_decode($data['dbpref'], true);
                    ?>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Choose preference</label>
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input spref" type="checkbox" id="inlineCheckbox1" value="Science" name="spref[]" <?php echo (in_array('Science', $dpref)) ? 'checked="checked"':'';?> />
                                    <label class="col-form-label form-check-label" for="inlineCheckbox1">Science</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input spref" type="checkbox" id="inlineCheckbox2" value="Commerce" name="spref[]" <?php echo (in_array('Commerce', $dpref)) ? 'checked="checked"':'';?> />
                                    <label class="form-check-label" for="inlineCheckbox2">Commerce</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input spref" type="checkbox" id="inlineCheckbox3" value="Arts" name="spref[]" <?php echo (in_array('Arts', $dpref))? 'checked="checked"':'';?> />
                    ...
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">Website</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?php //echo $input_error9;?>" id="inputWebsite" placeholder="Website" name="swebsite" value="<?php echo $data['dbwebsite'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control <?php //echo $input_error10;?>" id="exampleFormControlSelect1" name="scountry">
                                ...
                                <option value="Australia" <?php echo ($data['dbcountry']=='Australia')? 'selected="selected"':'';?>>Australia</option>
                                <option value="China" <?php echo ($data['dbcountry']=='China')? 'selected="selected"':'';?>>China</option>
                                <option value="India" <?php echo ($data['dbcountry']=='India')? 'selected="selected"':'';?>>India</option>
                                <option value="Japan" <?php echo ($data['dbcountry']=='Japan')? 'selected="selected"':'';?>>Japan</option>
                                <option value="US" <?php echo ($data['dbcountry']=='US')? 'selected="selected"':'';?>>US</option>
                            </select>
                    ...
                    <div class="form-group row"> -->
                        <div class="col-sm-10">
                            <div class="form-check">
                                <button type="button" class="btn btn-success" id="update_profile">Save</button>                                
    ...
    jQuery(function(){
         jQuery("#update_profile").on('click', function(e){
             _data = jQuery('#sturegForm').serialize();
            _data = _data + '&type=update_profile&id=32';
